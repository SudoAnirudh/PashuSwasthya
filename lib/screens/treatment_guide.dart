                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          item,
                          style: GoogleFonts.poppins(fontSize: 14, color: AppTheme.textPrimary.withOpacity(0.8)),
                        ),
                      ),
                    ],
                  ),
            ...
            children: [
              ...
              ...guide.emergencyContacts.map((contact) => Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(contact, style: const TextStyle(fontWeight: FontWeight.bold)),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          color: (_selectedGuide != null ? Colors.transparent : AppTheme.primaryGreen),
        ),
        title: Text(
          _selectedGuide != null 
          ...
          child: _buildGlassCard(
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                decoration: BoxDecoration(
                  color: (guide.isSevere ? Colors.red : AppTheme.primaryGreen).withOpacity(0.1),
                  shape: BoxShape.circle,
                ),
                child: Icon(
                  guide.isSevere ? Icons.warning_rounded : Icons.medical_services_rounded,
              ...
              subtitle: Text(
                guide.description.isEmpty ? guide.code : guide.description,
                maxLines: 1,
